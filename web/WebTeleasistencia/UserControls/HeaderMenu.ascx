...
<div id="toppanel">
    ...
    <owd:Window ID="WindowProfile" Width="450" Height="300" runat="server" StyleFolder="css/obout/windowstyles/dogma" IsResizable="false" VisibleOnLoad="false" IsModal="True" meta:resourcekey="userProfile" >
