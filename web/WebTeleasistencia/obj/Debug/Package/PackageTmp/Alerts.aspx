                    ...
                    <div style="text-align: center;">
                        <asp:GridView ID="gridAlarms" runat="server" Width="100%" AutoGenerateColumns="false">
                            ...
                            <Columns>
                                ...
                                <asp:CheckBoxField HeaderText="<%$Resources:Datagrid, sms%>" DataField="sms" ItemStyle-Width="11%" />
                    ...
                    <div style="text-align: left;" >
                        <asp:GridView ID="batteryGrid" runat="server" Width="100%" AutoGenerateColumns="false">
                            ...
                            <Columns>
                                ...
                                <asp:CheckBoxField HeaderText="<%$Resources:Datagrid, sms%>" DataField="sms" ItemStyle-HorizontalAlign="Center" />
