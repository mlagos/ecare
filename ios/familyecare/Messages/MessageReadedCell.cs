...
{
	[Register]
	public class MessageReadedCell : UITableViewCell
	{
		public string Title { 
		...
		public MessageReadedCell (UITableViewCellStyle style, string reuseIdentifier) : base(style, reuseIdentifier) 
		{    
			...
			this.TextLabel.Font = UIFont.SystemFontOfSize(18f);
