...
namespace familyecare
{
	public class RefreshTableHeaderView : UIView
	{
		...
		public RefreshTableHeaderView () : base()
		{
			...
			if (NSUserDefaults.StandardUserDefaults["FCM_RefreshTableView_LastRefresh"] != null) {
				lastUpdatedLabel.Text = NSUserDefaults.StandardUserDefaults["FCM_RefreshTableView_LastRefresh"].ToString ();
			} else {
				SetCurrentDate ();
			}
		...
		public void SetCurrentDate ()
		{
			...
			NSUserDefaults.StandardUserDefaults["FCM_RefreshTableView_LastRefresh"] = new NSString (DateTime.Now.ToString ("G"));
